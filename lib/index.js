...
var _DictionarySchema = require('./DictionarySchema.js');
...
function visitDictionary(obj, schema, bag, options) {
  var dictionaryStoredKeyName = schema.getDictionaryStoredKeyName();
...
function dictionaryOf(schema, options) {
  return new _DictionarySchema2.default(schema, options);
}
